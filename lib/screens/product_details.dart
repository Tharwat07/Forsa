...
import 'package:forsa/custom/text_styles.dart';
import 'package:forsa/ui_elements/list_product_card.dart';
import 'package:forsa/ui_elements/mini_product_card.dart';
...
class _ProductDetailsState extends State<ProductDetails>
  ...
  var _productImageList = [
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGW18LGSmBnkLbzM31dG1FPJb3jqVsFzYaEg&usqp=CAU",
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThXOhIXqb3wIJLrxJJlJ2fbibS-yaF-H41Ng&usqp=CAU"
  ];
  var _colorList = [
    Colors.red,
    Colors.black,
              ...
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: FadeInImage.assetNetwork(
                    ...
                    image:
                        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3XcPL0EURSyXvEEFyFRRkhj7kakB6bLXc2Nx41yOWr5E9JG8DrNeNHj3Is9QRf6628AA&usqp=CAU",
                    fit: BoxFit.cover,
                  ),
                ),
              ),
    ...
    return Row(
      children: [
        ...
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 8.0),
          child: Text(
            "(10 ${AppLocalizations.of(context).product_details_screen_available})",
            style: TextStyle(
  ...
  Widget buildColorItem(index) {
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        width: _selectedColorIndex == index ? 35 : 25,
        height: _selectedColorIndex == index ? 35 : 25,
        decoration: BoxDecoration(
          // border: Border.all(
          ...
          boxShadow: [
            BoxShadow(
              color: Colors.black
                  .withOpacity(_selectedColorIndex == index ? 0.50 : 0.12),
              blurRadius: 10,
              spreadRadius: 2.0,
      ...
      children: [
        RatingBar(
          ...
          ratingWidget: RatingWidget(
            ...
            empty: Icon(FontAwesome.star, color: Colors.amber),
          ),
          ...
          children: <Widget>[
            Expandable(
              collapsed: Container(
                ...
                child: Html(
                    data:
                        "According to the description on the site, the apartment’s kitchen is currently undergoing renovations.—William Thornton | Wthornton@al.com, al, 16 Dec. 2022"),
              ),
              expanded: Container(
                  child: Html(
                      data:
                          "According to the description on the site, the apartment’s kitchen is currently undergoing renovations.—William Thornton | Wthornton@al.com, al, 16 Dec. 2022 According to the fundraiser description, an update on the memorial service will be posted to the page once arrangements are finalized.—Adriana Pérez, Chicago Tribune, 4 Dec. 2022If at least some of the plot description sounds ripped from recent headlines, that's by design.—Maureen Lee Lenker, EW.com, 23 Nov. 2022The mercies of the law will be dispensed equally and impartially to every description of men; those of the judge, or of the executive power, will be the eccentric impulses of whimsical, capricious designing men.—James Freeman, WSJ, 11 Nov. 2022Winning was only part of the job description; players must churn out videos for the fanbase, promote merchandise and make commercials for corporate sponsors such as Honda and Verizon.—Los Angeles Times, 31 Oct. 2022According to the description, the package comes with an itty bitty cactus, a 1-inch ceramic planter, white sand, and care instructions.—Jennifer Aldrich, Better Homes & Gardens, 18 Oct. 2022No, that’s actually not part of the job description.—Zack Sharf, Variety, 13 Oct. 2022No, that’s actually not part of the job description.—Véronique Hyland, ELLE, 13 Oct. 2022")),
            ),
            Row(
